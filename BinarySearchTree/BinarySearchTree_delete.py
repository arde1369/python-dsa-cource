...
class BinarySearchTree:
    ...
    def __delete_node(self,current_node,value):
        if current_node == None:
            return None
        # the first if/elif conditions traverse the tree until you dont find the intended value in which case the first if statement runs or you find it in which case the else block runs
        if value < current_node.value:
            ...
            if current_node.right == None and current_node.left == None:
                return None
            #Node to be removed that has item(s) on the left and None on the right
            elif current_node.right == None:
                current_node = current_node.left
            #Node to be removed that has item(s) on the right and None on the left
            elif current_node.left == None:
                current_node = current_node.right
            #Node to be removed that has item(s) on BOTH sides
            else:
